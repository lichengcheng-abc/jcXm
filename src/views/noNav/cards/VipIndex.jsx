...
import two from '../../../assets/img/cart/vip_plus_free_shipping.95caaaa.png'
        ...
        const vipList = (
            <div>
                ...
                <section className={style.section}>
                    ...
                    <p className={style.vip_p}><span className={style.vip_h2}>专享折扣</span><i className={style.vip_back}>></i></p>
                    <div className={style.goodsList}>
                        {
                            goods.map(v=>(
                                ...
                                <p className={style.schedular_name}>{v.schedular_name}</p>
                                </div>
                            ))
                        }
                        {/* <div className={style.action_btn}>查看更多演出></div>             */}
                    </div>
                    </div>
                    <div className={style.double}>
                        ...
                        <div className={style.double_center}>
                            <h1>全场包邮</h1>
                            <img className={style.double_img} src={two} alt=""/>
                        </div>
                        <div className={style.mo}> 更多VIP+尊享权益，敬请期待</div>
                    </div>
                    
                </section>
                <footer className={style.footer}>立即开通￥99/年</footer>
            </div>
        )
        return (
            <div>
